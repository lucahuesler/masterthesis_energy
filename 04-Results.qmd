...
knitr::kable(obs_per_year, caption = "Number of buildings per survey year.")
...
summary_stats <- energy_modelling %>% skim()
...
energy_modelling %>%
  select(survey_year, 
         ...
         building_category, 
         building_class, 
         energy_consumed_measured_mwh, 
         num_residents, 
         heating_coefficient_measured, 
         gross_floor_area_m2, 
         heated_area_m2, 
