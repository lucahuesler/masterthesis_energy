...
pop_quarterly_stabl_mean <- pop_quarterly_stabl_transformed |>
  rowwise() |>
  mutate(pop_mean = mean(c(Q1, Q2, Q3, Q4), na.rm = T))
```
...
energy_clean_14 <- energy_clean_13 |>
  inner_join(pop_quarterly_stabl_mean, by = c("property_street" = "strname", "property_number" = "deinr", "property_zip" = "dplz4"))
...
write_rds(energy_clean_13, "data/energy_modelling.rds")
```
