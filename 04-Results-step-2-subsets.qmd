...
xgb_workflow <- workflow(recipe_base_hec, xgboost_spec)
```
...
multi_family_metrics <- xgb_fit_multifamily_family |>
  collect_metrics()
...
test <- bake(recipe_base_hec_building_class, new_data = vip_train) |>
  prep()
