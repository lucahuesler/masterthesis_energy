...
Step 1: Explore different models on small subset of training data
...
Idea that came to my mind: Also consider if building is stand-alone or connected to other buildings.

![](figures/freistehend_angebaut.png){width="300"}

(see also [Olu-Ajayi & al., 2021](https://www.sciencedirect.com/science/article/abs/pii/S235271022101264X))
