...
Train models with three different settings of variable selection:

-   With all predicotors
...
Top 10 models on (based on RMSE):
...
-   Best three models (RMSE) are without social indicators. Hypothesis: They do not improve the model because they are on hectare level.
