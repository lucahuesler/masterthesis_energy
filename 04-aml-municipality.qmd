...
ggplot(municipality_analysis, aes(x = municipality_name, y = average_hec)) +
...
municipality_analysis <- arrange(municipality_analysis, desc(average_hepi)) # Arrange from high to low
municipality_analysis$municipality_name <- factor(municipality_analysis$municipality_name, levels = municipality_analysis$municipality_name)

ggplot(municipality_analysis, aes(x = municipality_name, y = average_hepi)) +
...
models_by_municipality <- lapply(names(data_by_municipality)[1], function(name) {
