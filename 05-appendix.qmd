...
classification_energy_source_df <- energy_clean_06 %>%
  inner_join(gwr_building, by = "egid") %>%
  select(egid, energy_source_heat_1, gkat, gklas, gbauj, coordinate_e, coordinate_n, district_heating_role, gross_floor_area, num_dwellings, num_floors) %>%
